	...
	<div class="container"
		...
		<div class="row">
			...
			<div class="col-md-8" style="background: #fff; padding: 40px 80px; margin: 30px; border: 7px solid #ccc;">
				...
				<!-- 图书修改表单 -->
				<form action="" method="POST" id="signupForm" class="form-horizontal" style="margin-top: 5px;">
				
					<div class="form-group">
						<label for="username" class="col-sm-2 control-label">图书名称</label>
						<div class="col-sm-6">
							<input type="text"  name="name" value="" class="form-control" id="bname">
						</div>
					</div>
					...
					<div class="form-group">
						...
						<div class="col-sm-6">
							<input type="text" name="pricce" value="" class="form-control" id="bprice">
						</div>
					</div>
					...
					<div class="form-group">
						...
						<div class="col-sm-6">
							<input type="text" name="bnum" value="" class="form-control" id="bnum">
						</div>
					</div>
